...
export const createXosanSR = ({ template, pif, vlan, srs, glusterType, redundancy, brickSize }) => _call('xosan.createSR', {
  template,
  pif: pif.id,
  vlan: String(vlan),
  srs: resolveIds(srs),
...
export const replaceXosanBrick = (xosansr, previousBrick, newLvmSr, brickSize) => _call('xosan.replaceBrick', {xosansr, previousBrick, newLvmSr, brickSize})
